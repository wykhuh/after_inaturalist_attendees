...
# -   Use `&` with `filter()` since we want to pick observations by both
#     username and quality grade. Use 'quantron' as the user if you don't have
#     CNC observations.
...
# -   Use filter() to pick your username. Use 'quantron' as the user if you
#     don't have CNC observations.
...
# -   Use `filter()` to select observations with your username. Use 'quantron'
#     as the user if you don't have CNC observations.
